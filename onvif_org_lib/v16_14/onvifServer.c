/* onvifServer.c
   Generated by gSOAP 2.8.48 for all/all.h
...
SOAP_SOURCE_STAMP("@(#) onvifServer.c ver 2.8.48 2017-07-11 16:38:02 GMT")
SOAP_FMAC5 int SOAP_FMAC6 onvif_serve(struct soap *soap)
{
#ifndef WITH_FASTCGI
	...
	do
	{
		...
		if ((onvif_serve_request(soap) || (soap->fserveloop && soap->fserveloop(soap))) && soap->error && soap->error < SOAP_STOP)
		{
#ifdef WITH_FASTCGI
...
SOAP_FMAC5 int SOAP_FMAC6 onvif_serve_request(struct soap *soap)
{
